class DevicesController < ApplicationController
  before_action :set_device, only: [:add_user, :remove_user, :poll, :show, :edit, :update, :destroy, :play, :settings]
  ...
  def create
    ...
    respond_to do |format|
      if @device.save
        ...
        format.html { redirect_to @device; flash[:notice] = 'Device was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @device.update(device_params)
        format.html { redirect_to @device; flash[:notice] = 'Device was successfully updated.' }
